...
async function initMap() {
    if (!!document.querySelectorAll('.map').length) {
        ...
        document.querySelectorAll('.map').forEach(async mapEl => {
            ...
            // Initialize the map centered on RVM International's location
            map = new Map(mapEl, {
                center: {
                    lat: 30.045427788225517,
                    lng: 76.33414140000001
                },
                zoom: 15,
                disableDefaultUI: true,
                styles: [ /* Add the map styling here (as provided) */ ]
            });

            // Custom marker icon
            const icon = {
                url: `${path}/assets/images/marker.png`, // Path to your custom marker icon
                scaledSize: new google.maps.Size(35, 35), // scaled size of the icon
                origin: new google.maps.Point(0, 0), // icon origin
                anchor: new google.maps.Point(0, 0) // icon anchor point
            };

            // Place the marker at the exact location
            const marker = new google.maps.Marker({
                position: {
                    lat: 30.04557638312565, 
                    lng: 76.33409848465547
                },
                map,
                icon: icon // Attach custom marker icon
            });

            // Create the info window content with the address and a link to Google Maps
            const contentString =
<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13814.856781879285!2d76.3341414!3d30.0450563!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3911d11c0596651f%3A0xe9ba01df5cd1773f!2sRVM%20INTERNATIONAL!5e0!3m2!1sen!2sin!4v1726971874838!5m2!1sen!2sin" 
    width="600" 
    height="450" 
    style="border:0;" 
    allowfullscreen 
